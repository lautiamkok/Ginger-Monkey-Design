...
function crb_attach_post_meta_thumbnail_attributes() {
    Container::make('post_meta', __('Thumbnail (Featured Image) Attributes'))
        ->add_tab(__('Title'), [
        ...
        ->add_tab(__('Alternative (alt) Text'), [
             Field::make('text', 'thumbnail_alt', __(''))
                ->set_help_text('Set a plain alt text to the thumbnail. Meta ID: thumbnail_alt.')
                ->set_width(100),
        ])
        ...
        //         ->set_options(set_column_size_options()),
        // ])
        ...
        // ->add_tab(__('Order'), [
        //     Field::make('select', 'thumbnail_order', __(''))
        //         ->set_help_text('Set an order to this thumbnail on large screens. Meta ID: thumbnail_order.')
        //         ->set_options(set_order_options()),
        // ])
