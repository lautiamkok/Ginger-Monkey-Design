...
<!-- block -->
<div 
  class="relative overflow-hidden w-full h-screen-lg <md:h-screen-sm border-0 border-green-500"
  data-aos="fade-up" 
  data-aos-duration="1000"
  data-aos-delay="500"
>

  <div class="parallax w-full h-screen-lg <md:h-screen-sm border-blue-500 border-0" data-parallax-speed="4">
    <img 
      class="
        w-full 
        h-full
  ...
  <!-- frame top-->
  <div 
    class="absolute bottom-0 left-0 right-0 bg-bottom bg-cover bg-repeat-x bg-contain <2xl:bg-auto h-[16px] border-0 border-green-500 z-9"
